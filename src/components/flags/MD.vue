<template>
  <svg id="flag-icons-md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <path
      fill-rule="evenodd"
      d="M336.8 307.5c0 1.5-2 2.7-4.3 2.7-2.4 0-4.3-1.2-4.3-2.7s2-2.7 4.3-2.7 4.3 1.2 4.3 2.7m-22.3 0c0 1.5-1.9 2.7-4.2 2.7s-4.3-1.2-4.3-2.7 1.9-2.7 4.3-2.7c2.3 0 4.2 1.2 4.2 2.7"
    />
    <path
      fill="#ff0"
      fill-rule="evenodd"
    ...
    <path
      ...
      stroke="#000"
      stroke-width="1.1"
      d="M535 659c-3.5-7-14.1-10.6-21.2-10.6s-14.2 0-21.3 10.7c0-14.2 10.5-21.3 21.3-21.3a23 23 0 0 1 21.2 21.3z"
    ...
    <g fill-rule="evenodd">
      ...
      <path
        fill="#da4500"
        d="M304.3 112.6a79 79 0 0 0-29.3 3.9c0-7.2 8.4-15.6 22.8-15.6 3.2 0 6.5 7.8 6.5 11.7"
      />
    </g>
    <g fill-rule="evenodd">
      <path
