<template>
  <svg id="flag-icons-sm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <path
      ...
      stroke="#7d6c00"
      stroke-width="2.4"
      d="M317 339.2C369.6 300 426 220 359.9 177.8c-12.3-2.4-26-1.7-32.7 3.6-3.5-2-6.3-1.8-9.8 1.9-2.5-3-5-4.4-10-2.9a41 41 0 0 0-31.5-3C218 211.8 253.4 294 317 339.1z"
    />
    <g stroke="#3a9d4f">
      <path
        fill="#4fd46b"
      ...
      <path
        ...
        stroke-linejoin="round"
        stroke-width="2.4"
        d="M404.5 266.4c-4.1-3.1-6.4-6.9-5.7-10.6-2.7-3.7-4.6-5.9-2-9.2l-2-7.5c-5.4-2-3.1-6.5-1.7-8.1q-3.8-5.4-.2-10.4c0-6.5 4.6-4 8.3 0 0 0 6.4 4.5 1.7 8.5 4.7 1.7 6 5.7 3.4 7.4 4.1 1.8 4.7 5.5 2.5 8 4.1 3.2 2.6 7.4 3.8 11.1z"
      />
      <path
        fill="#4fd46b"
        fill-rule="evenodd"
    ...
    <path
      fill="#8fc753"
      fill-rule="evenodd"
      d="M317 332.4a213 213 0 0 1-42.3-57.6c2-1.7 2.9-2.2 3.9-5 5.8.8 8.9 1 16.5-.4 1.6 5.8 1.9 10.6 5.5 15.4l7.7-15a34 34 0 0 0 16.5 0c3.2 4.2 2 10.7 7.7 15.6 3.4-10 6.7-10.6 10.1-16 5 1.8 8.2 1 12.3-.3 2 2.5 1 2.4 5 6a194 194 0 0 1-42.8 57.3z"
    />
    <path
      fill="#fff"
      fill-rule="evenodd"
    ...
    <path
      fill="#c76e2e"
      fill-rule="evenodd"
      d="M354.3 284.7c-.2 0-3 2-3 2l-4.2 1.7-4.4.1-1-3 3.4-3q-4.4-.6-8 2.8s0 3.3 2 5c1.1 1.4 4.5 4 4.5 4a7 7 0 0 0 5.4-1zm-23.2 30.1c1.4.4 11.3-12.7 11.3-12.7a10 10 0 0 0-4.9-5.4s-4.8 5.7-4.9 7.6c-.8 1.7-3 8.3-2 9.2-.1.2-.5 2.9.5 1.3"
    />
    <path
      fill="#006800"
      fill-rule="evenodd"
    ...
    <g font-family="Trebuchet MS" font-size="9" font-weight="bold">
      ...
      />
      <path
        d="m344.4 339.7.6-1.7q1.2.7 2.2.7 1.7 0 1.7-1.2l-.4-1-1.6-1.1-1.7-1-.7-1-.1-1.2q0-1.3.8-2.2 1-.6 2.3-.6 1.9 0 2.9.6l-.7 1.7q-1-.8-2.2-.8-.6 0-1 .3-.3.3-.3 1 0 .8 2 1.8 1.2.5 1.7 1l.6 1 .2 1.4q0 1.3-1 2.1t-2.7.9-2.6-.9z"
        aria-label="S"
      />
    </g>
    <path
