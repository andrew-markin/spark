<template>
  ...
  >
    ...
    <path
      ...
      stroke="#000"
      stroke-width="1.2"
      d="M439.8 327.7c0 .8-2.2 30.2-10.9 40.4-8.6 10.3-23 16.6-28.2 15.1-5-1.6-16.5-31.3-16.5-31.3s12.2 14.2 21.3 11.8 14.6-20.1 16.3-28.9c1.7-8.6.3-25.7.3-25.7l17.8 18.6z"
    />
    <path
      fill="url(#fk-e)"
      fill-rule="evenodd"
    ...
    <path
      ...
      stroke="#000"
      stroke-width="1.2"
      d="M519.3 327.7c0 .8 2.2 30.2 10.9 40.4 8.7 10.3 23 16.6 28.2 15.1 5-1.6 16.6-31.3 16.6-31.3s-12.3 14.2-21.4 11.8-14.5-20.1-16.2-28.9c-1.8-8.6-.4-25.7-.4-25.7z"
    />
    <path
      fill="url(#fk-g)"
      fill-rule="evenodd"
      stroke="#000"
      stroke-width="1.5"
      d="M401.2 326.2c-4 5.5-6.1 9.8-7.9 13q-2.5 4.7 3.2 14c4.3 6.7 39 33.4 84.1 33.4 45.2 0 79.8-26.6 84-33.4q6-9.4 3.3-14c-1.7-3.2-3.9-7.5-7.9-13 0 8.3-28.7 38.5-79.4 38.5s-79.4-30.2-79.4-38.5z"
    />
    <path
      fill="url(#fk-h)"
      fill-rule="evenodd"
    ...
    <g transform="matrix(.86465 0 0 .97062 -175.4 2.5)">
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M363 560.2s3 30 36.4 29.1 42.7-30.2 42.7-30.2l-14.5-.6c-.3 0-11.6 14-26.2 13.7s-19.2-3.8-22.4-6.7-6-7.3-6-7.3l-17-6.7 1 6.4zm90.3-3-1-4v-3.4l1.6-3.6s-25.3 3.7-25.3 4l-.1 6.8 24.8.1z"
        transform="matrix(1.25 0 0 1.3 259.4 -430)"
      />
      <path
        fill="none"
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M365 514.3c.7 0 7 3.2 9.7 2.4s.9-3 1.4-3c.6 0 2.6 1.5 3.8.3s2-4.6 1.5-4.3-16 5.8-16.3 4.6z"
        transform="matrix(1.25 0 0 1.3 259.4 -430)"
      />
      <path
        fill="#dd8b59"
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M363 540.8c.4 0 0 2.6 2.4 2 2.3-.6 2.9-2 2.9-2s.6 3.2 3.8 2.9 5-3.8 5-3.8.2 2.6 2.2 1.7 2.6-2.9 2.6-2.9l-18.3 2.6zm0-17.2s-2.6.9-1.7 6.1 3 8.2 3.2 8.2 2.6-5 6.1-5.8c3.5-1 9.6 2.6 9.6 2.6s-.6-4.7.3-9a18 18 0 0 1 3.8-7.6s-20.4 5.5-21.2 5.5z"
        transform="matrix(1.25 0 0 1.3 259.4 -430)"
      />
      <path
        fill="#dd8b59"
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M389 510c1 .2 3.1 3.2 4.3 2.6s2.9-2.4 2.9-2.4-.3 3.5 2 3c2.4-.6 2.7-3 2.7-3s1.7 1 3.2 0c1.4-.8 2.8-5.2 2.3-5.2s-16.9 5.2-17.5 5zm-.6 8.4c0 .6-3 5.2-2 9.6s2.5 8.4 2.8 8.4 4.7-4.6 8.5-5.5 9.3 2.9 9 2.9-1.5-4.4-1.5-7.6 4.4-13 4.4-13zm0 21c0 .2.8 2.2 2.9 2.2s2.3-2 2.3-2-.3 3.5 2.9 3.2 4.3-3.5 4.3-3.5.3 1.8 3 .9c2.6-.9 6-3.8 5.8-3.8s-21 3.8-21.3 3z"
        transform="matrix(1.25 0 0 1.3 259.4 -430)"
      />
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M391 439s3.4 19.2 10.4 23.6l12.8 8.1"
      ...
      <path
        ...
        stroke="#512007"
        stroke-width=".5"
        d="M384.6 471.1a2.2 2.2 0 1 1-4.4 0 2.2 2.2 0 0 1 4.4 0zm10.7 4.7a1.9 1.9 0 1 1-3.8 0 1.9 1.9 0 0 1 3.8 0zM409 477a1.9 1.9 0 1 1-3.8 0 1.9 1.9 0 0 1 3.8 0zm11.9-4.5q-.1 1.6-1.6 1.7-1.5-.2-1.6-1.7c0-.9.7-1.8 1.6-1.8q1.5.1 1.6 1.8zm9.6-5.7q-.2 1.5-1.9 1.6c-1 0-1.9-.7-1.9-1.6s.9-1.6 1.9-1.6q1.7.1 1.9 1.6z"
        transform="matrix(1.25 0 0 1.3 256.3 -299.5)"
      />
      <path
        fill="red"
