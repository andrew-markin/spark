<template>
  ...
  >
    ...
    <g stroke="#000" stroke-width="1.4" transform="translate(-306.8 -21.2)scale(.87136)">
      ...
      <g fill="#f9d050" stroke-width=".6">
        <g id="ky-f">
          ...
          <path
            d="M916.9 150a85 85 0 0 1 37.8-31.6c-12 12-29.7 34-34 42.7m2.9-.5c8.6-4.8 25.9-12.5 38.3-10-7.6 2.8-30.6 13.3-40.7 23"
          />
          <path
            d="M921.7 157.2c8.1-8.6 23-21.5 38.8-26.8-11.5 11-36 36-39.3 39.8M898.7 152c-5.8-17.8-14.4-34.5-27.3-39.8a131 131 0 0 1 21 48.9m-4.8-9.6c-9.5-11.5-22.5-23-37.3-25.4a90 90 0 0 1 33 38.8"
          />
        ...
        <g id="ky-g">
          ...
          />
          <path
            d="M891.5 140c.5-4.8 3.8-8.6 6.7-8.2s4.3 6.3 3.8 9.6c-.5 3.8-3.8 6.7-6.2 6.2-2.4 0-4.8-3.3-4.3-7.6zm12.9 1.4c-1-4.3 1-9 3.9-9.6 2.8-.4 5.7 4.3 6.2 8.2 1 3.8-1.5 7.6-3.9 7.6-2.3.5-5.7-1.9-6.2-6.2z"
          />
          <path
          ...
          />
          <path
            d="M905.4 159.6c.5-4.3 3.3-8.6 5.7-8.1 2.9 0 4.3 5.7 3.9 9-.5 4.4-3 7.3-5.3 6.8-2.4 0-4.8-3.4-4.3-7.7zM892 161c-1.5-4.7-4.4-8-6.3-7.6s-2.4 6.2-1.4 9.6c1 3.8 3.8 6.2 5.7 5.7 1.5-.4 3-3.8 2-7.6z"
          />
          <path
      ...
      <g id="ky-e" fill="#059334">
        ...
        <g fill="none">
          <path
            fill="#000001"
            stroke="none"
            d="M840.7 172c-1 0-1.5-2.8-3.4-2.8-.5 0-1.9.5-2.4 0q.1 1.6 1 2.4c.5 1.4 2.9.5 4.8.5z"
          />
          <path
            d="M840.7 180.2c5.7 0 6.7-7.2 9.6-7.6m-6.3 8.1c4.3 2 7.7-8.1 11-7.7m-19.6-4.7c1.4 0 2.4-2 4.8.4q1.7 1.5 3.4 1.5m-1 5.2c-2 3-5.3 4.8-7.2 3.9m-1-15.8c-1.4 1-2.3 2.8-3.3 4.3m-1.4 2.8v2.4"
          />
        </g>
      </g>
    </g>
    <g stroke-width="1.4" transform="translate(-306.8 -21.2)scale(.87136)">
      ...
      <path
        fill="#c8102e"
        d="M900.1 312c4.3 0 11-3.8 16.8-9.6 6.2-6.7 16.8-9 27.8 0s17.7 5.3 23.5 0c5.7-5.2 10.5-7.2 21.5-7.2V233H810v62.3c11 0 15.8 2 21.6 7.2 5.7 5.3 12.4 9.1 23.5 0 11.5-9 21.5-6.7 28.2 0 5.3 5.8 12 9.6 16.8 9.6z"
      />
      <path
        fill="#0b50a0"
      ...
      <g stroke="#000">
        ...
        <g fill="none">
          ...
          />
          <path
            d="M880 271.8c2.9-2 3.3-4.8 3.3-9.1m0 4.8c2-1.5 2.4-2.4 2.4-6.8m-6.2-12.9c-1 0-2 .5-2 2 0 .9-1.4 2.3-1.4 3.8q-.6 2.8-2.8 1.9c-1.5-1-1.5-1-1.5-2.4 0-2 2.4-2.4 2.4-4.3.5-1 1-2.4 1.5-2.4-2.4 1.4-5.8.4-6.3-2.4"
          />
