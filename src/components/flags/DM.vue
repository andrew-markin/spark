<template>
  <svg id="flag-icons-dm" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    <defs>
      <clipPath id="dm-a">
      ...
      <g transform="translate(-250.6 359.4)scale(1.04)">
        ...
        <g stroke="#000" transform="translate(72.9 -9.8)">
          <path
            fill="#a95600"
            stroke-width=".5"
            d="M388.5-53c6-.3 3.4-3.3 6.4-5 3-1.6 7.3-.6 8.6 1.4s.3 4 2 4 47-2.5 48.6-.9 2 5 .3 6.3c-1.6 1.4-58.9 3-60.9 1.6s-5-7-5-7.4z"
          />
          <path
            fill="#ff0"
            stroke-width="3.9"
        ...
        <g transform="rotate(1 -589.6 681.6)">
          <path
            ...
            stroke="#000"
            stroke-width="2.5"
            d="M211.2 247.3c21.7-12 56.6-9.8 79.7 11.2 19.4 17 45.3 75.2 70.3 92.8a58 58 0 0 1-42.2-15.2c-28.8 15.5-38.1 16.7-64 15.7-35.8-1.4-62.4-17.7-68-40.6-6.3-21.8 4.8-52.5 24.2-63.9z"
