<template>
  <svg id="flag-icons-im" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    <defs>
      <clipPath id="im-a">
    ...
    <g clip-path="url(#im-a)" transform="translate(72.8)scale(.94)">
      ...
      <path
        ...
        stroke="#000"
        stroke-width="2.2"
        d="M381.8 120.7c-.6 0-6.3 2.8-6.2 3 .1.1-4.8 13.5-4.9 13.4-.1-.2-3.5-11.7-3.9-11.5s-12.3 1.6-12.4 1.7l9-11.5-1.3-12.5 9.8 3.8 10.5-8c.2-.1-2.7 10.8-2.7 10.8l5.2 7.2s-3 3-3.1 3.6z"
      />
      <path
        fill="#fff"
        fill-rule="evenodd"
      ...
      <path
        ...
        stroke="#000"
        stroke-width="2.2"
        d="M250.8 231.3c.5-.4-5.6 2.8-7.2 3.6-28.1 15-42.6 37-43.5 37.8l-2.2 3.4-2.3 3-3.6 4.7c-.2.6.4-.3.2.2m77.9-70.6a79 79 0 0 0 6.5 4.7c26.2 18.2 52.3 21.1 53.5 21.5l4 .5 3.8.5c1.4.2 4.4.8 5.8 1.2.6-.2-.5-.3 0-.4"
      />
    </g>
  </svg>
</template>
