<template>
  <svg id="flag-icons-fj" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480">
    ...
    <g stroke-miterlimit="4.8">
      ...
      <g stroke-miterlimit="3">
        ...
        <g transform="translate(-96.9 97.5)scale(.66486)">
          ...
          />
          <path
            d="M839.2 178.7q1.3.8 3.7 0c0 .5 0 1.7 1 2.5q1.8 1.5 5.5.6v-.5q-3.6.9-5.2-.5a3 3 0 0 1-.9-2.4v-.4l-.3.2q-2.2 1-3.6 0c-1.5-1-1.4-3.7-1.4-3.7h-.4s-.2 3 1.6 4.2"
          />
          <path
            d="M842 175q-.8.4-.8 1.1v.3c.2 1.2 1.5 2 2.6 2.3s2.6.4 3.1-.3q.4-.4 0-1.7a3.7 3.7 0 0 0-4.8-1.7zm2 3.3c-1-.3-2.2-1-2.3-2 0 0-.1-.7.5-.9a3.3 3.3 0 0 1 4.2 1.6q.4.7.1 1c-.3.5-1.4.6-2.5.3m-.4 2.7c-.3 2.5 0 2.6.1 2.6h.2l.2-.1 1.4-2-1.8-.8v.3zm.5.4.7.3-.8 1.1zm-4.2-2.4-.1 2.3 2-2.4-2-.2zm.4.2h.6l-.6.8z"
          />
          <path
            d="M838.5 178.2s1.5 2.9 1.8 4q.3 1 2 1.7t2.7-.1l1.3-1.1q.5-.7 1-.5v-.5q-.8 0-1.3.6l-1.3 1c-.8.6-1.7.4-2.2.2q-1.6-.6-1.8-1.5c-.3-1-1.7-3.9-1.8-4zm2-8.6a5 5 0 0 0-2.4 2.8l.4.1s.7-1.8 2.1-2.5a3 3 0 0 1 2.4 0l.1-.4q-1.4-.6-2.7 0zm10.8 5.2c.2 0 3.2 2.4 1.5 5.2l.3.3c2-3.3-1.5-5.9-1.5-6zm-9.2.4s-.5 1.7 2 2.3c0 0-2.3 0-2.5-.6-.1-.6 0-1.9.5-1.7m7.5 2q0 .3-.3.3l-.3-.2q0-.3.3-.3t.3.3zm.2 1.2q0 .2-.2.2l-.3-.2.3-.3q.2 0 .2.3"
          />
          <circle cx="848" cy="177.8" r=".3" />
          <path
            d="M848.8 179.4a.3.3 0 1 1-.6 0q0-.2.3-.2zm-7.1-7.3a.3.3 0 0 1-.6 0 .3.3 0 0 1 .5 0z"
          />
          <circle cx="841.6" cy="173.2" r=".3" />
          <circle cx="840.1" cy="172.7" r=".3" />
          <path
            d="m840.8 174.3-.2.3a.3.3 0 0 1 0-.6zm4.8-9.6s3.5 2.2.1 6.3c0 0 1.7-1.3 1.8-3.4s-1.2-3.8-2-2.9zm13.5 5.9c-1.2.6-2.8-.5-3.6-1.5s-2.5-1.3-3.6.6c-1 1.8-2.5 2.5-2.5 2.5s1.5-.8 3-2.5 2.4-.3 3.9.5c1.4.8 1.7 1 2.7.5v-.1z"
          />
          <path
            d="M858.8 170.9a2 2 0 0 1-2.2-.1c-1-.8-1.7-1.8-2.8-1.2-1.2.6-3.3 2.2-3.3 2.2s3.5-2.4 4.2-1.8c.6.5 2.2 1.8 3.1 1.4z"
          />
          <path
            d="M856.1 172.3c-1.1-.8-2.2 1-3.1.8-1-.2-1.7-1.8-1.7-1.8s.8 1.6 2 1.3c1.3-.4 2.1-1.2 2.9-.6s-.1.3-.1.3"
          />
          <path d="M854.4 172.6a2 2 0 0 1-2.4-1.9s.7 1.8 2.6 1.5z" />
          <path
            d="M854.3 171.2q.3.8-.5.8-1.1 0-1-.8c0-.5 1.4-.4 1.5 0m-7.8-3a1 1 0 0 1-.7.6q-.6 0-.5-.6c.1-.6 0-.7.5-.7s.7.3.7.7"
          />
          <path d="M844 165.7s3.8 0 2 4.7c0 0 1.4-2.3.5-4-1-1.6-2.3-1.2-2.3-1.2s-.4.3-.2.5" />
          <path
            d="M844 167.6q0 1.4 1.8 2.9l.3-.4q-1.7-1.3-1.7-2.5c0-1.2.6-1.3.6-1.3l-.3-.3s-.7.6-.8 1.6z"
          />
          <path
            d="M844.8 168.4q.2.8 1.2 1.2l.2-.4q-.8-.3-1-1c-.2-.8.4-1.7.4-1.7l-.4-.3s-.7 1.2-.4 2.2m5.1 2.6s.7 1.5-.3 3.1l-1 1.6s1.2-2.3.7-3.2.6-1.5.6-1.5m14.6 15.8c3.8.7 12.5 7.5 12.5 7.5l.5-.6c-.3-.3-8.9-7-12.9-7.7zm3.4 9.5c.2 3.5 4 5.6 4 5.7l.5-.7s-3.5-2-3.7-5zm-9.3.8c0 3.8 3.6 8.4 3.8 8.6l.6-.5s-3.6-4.6-3.6-8.1zm-12.1.4q.8 1.9.4 2.2-.5.5-.6.4l.1.8q.6 0 1.2-.8.6-1-.4-3z"
          />
        </g>
      ...
      <g fill="#00a651" stroke="#000" stroke-width=".8">
        ...
        <path
          stroke-width=".5"
          d="M456.5 268.1s2.3-15.1 12.2-15.4c9.9-.2 6.6.8 9-.8 0 0-6.6 3.4-10.7 4-4.2.4-7.6 8.5-7.4 10 0 1.5-2.3 4.4-3.4 3.4s.3-1.2.3-1.2z"
        />
        <path
          stroke-width=".5"
        ...
        <path
          stroke-width=".5"
          d="m441.3 286.8-1.4-1c-.7-.6-7.2-2.3-8.1 4 0 0-2.4-6.3 1-7 3.5-1 6.2 1 8.5 4m-5-12.8s2.3 5.2 3.2 5.4 1.5-.6 1.5-.6-3.1-4.6-4.8-4.8zm-1.8-7.9s-2-6.6-4.4-4.8-1.8 6.5-1.8 6.5-4.7-5-2-8.8 8.2.4 8.2 7.1z"
        />
        <path
          fill="#964b36"
          stroke-width=".5"
        ...
        <path
          stroke-width=".5"
          d="M442.8 281.3s-8.3-15.7-13.7-4.5c0 0-1 2.9.1 4 0 0-3-2.3-1.6-7.8s10.5-3 13.2 1.5 3.3 6.8 3 7c-.4.3-1-.2-1-.2zm23.3 4.5s6-12.4 9.5-6.8c0 0 1 2.8-.5 4 0 0-2.4-3-4.5.6-2.2 3.5-1.3 3.2-1.3 3.2s-2.2.6-3.2-1z"
        />
        <path
          stroke-width=".5"
        ...
        <path
          stroke-width=".5"
          d="M473 268s-4.8-9.8-8-10.8 1.7-2.5 3.7-.6 5.8 4.3 5.4 9.3zm-5 13.4s1.4-6.6 5.2-8.6 7.3-1.3 7.3-1.3-4.5 1-5.3 3.3-2 2.4-2 2.4z"
        />
        <path
          fill="#964b36"
          stroke-width=".5"
      ...
      <g fill="#964b36" stroke="#000" stroke-width=".3">
        <path
          d="m542 299.8-.3.3.4-.3zm9.3-2.3-.3-.2-.4-.8h-.3l-.7-1.4v-.7s-.2 0-.3-.2v-1.6l-.1-.5-.3-1.1v-1l-.1-1 .1-.9v-5.4l-.1-1-.1-.4v-1.6 2.6l-.2-4.3-3.4-1.6s-.3 6.2-.2 7c0 .9.4 6.7.2 7.4l-.5 4.3s-1.6 1.2-2.2 2.4c-.7 1.3-.5 1.7-.7 1.7l1.5-.2-1.1.8.7.1.2.2.2-.2c.3 0 .5.4.7.3l.4-.2.2-.4h1.1q.5-.2.9-.7.3-.3.7-.3l1 .3q.3 0 .5-.2l.4-.6.8-.1.4.1h.6l.3.2.2-.4z"
        />
        <path
          d="M544.5 299.7h.6v.2h.2l.3.2h.3l.4.1q.3.1.6-.1t.6.2q.1.2.2 0l.1-.1.3-.1.3-.1.4-.2.4.2h.2l.7-.5h1.4l.2-.3.7.4c.1.1.7.2.6-.2s-.4-.1-.5-.4v-.6l-.3-.4h-.4l-.2-.6-.3.2q-.2 0-.3-.3c-.3-.3-.4.2-.7.1q-.3-.2-.5-.7t-.5-.4q-.2.3 0 .7h-.5q-.2 0-.3.2-.2.7-.7.6h-.4l-.5.2h-.4l-.4-.4a.1.1 0 0 0-.2 0l-.1-.2q-.2 0-.3.3l-.1.5-.3.4-.4.1c-.2 0-.4.3-.4 0-.2-.4.3-1.1-.2-1l-.3.2v.7c-.1.3-.7.8-.6 1 0 .3.4 0 .4 0l.2.4c.2.3.7-.4.7 0m-2.1-2.7v-.2l-.4-.1q-.3.1-.5.4c-.2.4-.2 1-.6 1h-.5v1s-.2 0-.2.2q0 .4.4.2h1l.5-.1q.3 0 .5-.2l.2-.4v-.4l.3-.4c.1-.7-.6-.2-.5-.9"
        />
      </g>
      <g stroke="#000" stroke-width=".5">
        <path
          d="M550.8 277.9q-.1 1.5-1.4 1.6-1.2-.1-1.4-1.6.2-1.5 1.4-1.6 1.3.1 1.4 1.6zm-4.5-2q-.1 1.5-1.4 1.6c-1.3.1-1.4-.7-1.4-1.6q.2-1.6 1.4-1.6c1.2 0 1.4.7 1.4 1.6z"
        />
      ...
      />
      <path
        d="m543.9 263 .6 1.3-1-.4 2.9 5.2.4-.5-.6 1.5.5.2 1.2-3.2-.4-.3-1 1.3-1.8-3.1.8.3-.8-1.7 1.1.6v-1.9h-.5v1l-1.8-1.1zm-1.9 6.4.2.5q1.2-.5 2-.2.7.6.7 1l.5-.2s-.2-.9-1-1.2q-.9-.5-2.4.1m2.3 5.4-.5-2.8h.6l.4 2.7zm3.8-.4-.7-2.2.5-.1.7 2zm1.4 1.5-.5-2.1.5-.1.6 2.1z"
      />
      <path
        fill="#00a651"
        stroke="#000"
      ...
      <path
        ...
        stroke="#000"
        stroke-width=".7"
        d="M471.2 341c2-1 2.4-5 2.4-5-.5 1.4-4.2 2.9-4.2 2.9 2.7-1.7 6-9.4 6-9.4-.8 2.7-8 5-12.6 7.6s-2.2 10-2.2 10c-1.3-.9-3.8-4.8-4.3-8.3s-1.8-4.9-5-5.3c-3.1-.4-5 3.2-5 3.2l-4.7 2.4 4.8.2s3.4 1.1 3.4 3.8-3 13.3 2 19.3c3.3 4.1 16 6.5 16 6.5"
      />
      <path
        fill="#fff"
        stroke="#000"
      ...
      <path
        ...
        stroke="#000"
        stroke-width=".7"
        d="M469 356.5s4.1 6.8 4.5 10.4c0 0 7.8 8.5 10.7 9 0 0-1.4.6-4-1.5 0 0 2.2 2.2 2.6 2.3s-1.7-.2-2-.8l1.4 1.5-.5-.2s-1-.1-1.6-.5c-.5-.4-.1 1-.1 1s-1.2-.3-1.6-.7.1.9.1.9l-1-.3-.8.5s0 .5-.5 0c-.5-.3-1.4 0-1.4 0s-.6.6-1 .2c-.3-.4-1.5 1.6-1.5 1.6l-5-12.3"
      />
      <path
      ...
      <g transform="translate(-96.9 97.5)scale(.66486)">
        <path
          d="M823.4 360.8s-1.2-2.2-2.3-1.3q-1.5 1.1-1.8.9s1 0 1.7-.5q1-1 2.4 1zm-6.6-1 .7 1.4-.8 2.3.6.2.7-2.5-.7-1.6z"
        />
      ...
      <g fill="#964b36" stroke="#000" stroke-width=".5">
        <path
          stroke-width=".3"
          d="M549.4 334.8s5.6-7.4 10.6-5.5l8.1 3s.1 4.9-2.5 4.9-5.2-5-7.6-3.5a13 13 0 0 0-4.5 4.2c-.1.7-6.3.8-4.1-3.1z"
        />
        <path d="M528.2 370.4s-1.6 1.6-.9 2 2.1 0 2.1-.6-1-1.6-1.2-1.4z" />
        <path
          d="M527 372s-3-1.7-5.2 2.2c-2.3 3.8-4.1 10.1-5.4 11-1.3.8 12.8-6.2 13-9.2 0 0 .9-3.8-.6-3.7s-1.6.2-1.9-.4z"
        />
        <path
          stroke-width=".3"
      ...
      <path
        ...
        stroke="#000"
        stroke-width=".3"
        d="M528.6 354.2s-1.5-9.9 4.4-13c0 0 1.1-.2 1.7 1.2 0 0 3.1-1.3 3.2 1.3 0 0 1.6-1.2 2 .5 0 0 3.3-.7 2.7 1.8 0 0 2.8-.8 2.5 1.6 0 0 2.8-1 2.4 1 0 0 3-.6 2.2 1.8 0 0 3.7-.4 2.6 2.1 0 0 2.7-.7 2 1.4 0 0 3.6.7 2 3a24 24 0 0 1-9.8 7"
      />
      <path
        fill="#00a651"
        stroke="#000"
        stroke-width=".3"
        d="M525.4 364.1s-2.4-8.2 2.2-10.3c0 0 .9-.2 1 .6 0 0 1-1.3 1.8-.1 0 0 2.3-1.1 2.9.6 0 0 1.5-1.3 2.3.6 0 0 1.5-.6 1.5 1 0 0 2-1 2 1 0 0 2-.8 1.5 1.2 0 0 3 .5 2.1 1.9 0 0 2.7.7 1.7 1.8 0 0 2.8-.3 1.3 1.6 0 0 2.2-.7 1 1.7s-5.2 5-8 5.4"
      />
      <path
        fill="#00a651"
        stroke="#000"
      ...
      />
      <path
        d="m529 371 .3.1c1.3-2.8 1.7-4.8 1.7-4.8h-.3s-.4 1.9-1.7 4.7m.3.1.2.3a7 7 0 0 0 3-4h-.3s-.6 2.4-2.9 3.7m.5.2v.3c2.4-.2 4-3.1 4-3.3h-.2s-1.6 2.8-3.8 3"
      />
