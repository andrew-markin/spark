    ...
    <g fill="none" stroke="#000">
      ...
      <g stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2">
        ...
        <path
          fill="#f1b2dc"
          stroke-width=".3"
          d="M443.4 248.6c-1.4-3.2-2.9-6.5.7-13.5 3.8-7.1 1.4-12.5.3-16.1-1.1-3.5-1.4-6.8 0-8.3 1.5-1.3 2.1-2.2 2.2-4.6.1-2.2 2-1.5 2.3-.4s.5 3-1.5 6.4 5.6 12 2.1 21.1c-2.4 6.4.8 14.5 2 20.2s2 19-6.3 21c5.7-2.7.4-20.5-1.8-25.8"
        />
        <path
          stroke-width=".3"
